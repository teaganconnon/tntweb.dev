  ...
  return (
    <div className={classes.sectionDiv}>
      <Controller globalSceneOptions={{ triggerHook: 'onLeave' }}>
        ...
        <Scene pin>
          <div className={classes.panel} style={{ backgroundColor: "#38ced7" }}><span>Panel</span></div>
        </Scene>
        <Scene pin>
          <div className={classes.panel} style={{ backgroundColor: "#22d659" }}><span>Panel</span></div>
        </Scene>
        <Scene pin>
